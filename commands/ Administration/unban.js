    ...
    try {
      ...
      if(!args[0])
        return message.reply({embeds :[new MessageEmbed()
          ...
          .setTitle(`<:icons_Wrong:988298434354249809> Please add a valid USERID`)
      ...
      if (!bans.map(b=>b?.user.id).includes(args[0]))
        return message.reply({embeds :[new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(client.getFooter(es))
          .setTitle(`<:icons_Wrong:988298434354249809> The User with that Id is not banned in this Server!`)
      ...
      try{
        ...
        return message.reply({embeds :[new MessageEmbed()
          .setColor(es.color)
          .setFooter(client.getFooter(es))
          .setTitle(`<:icons_Correct:987931568939102228> Successfully Unbanned ${banuser ? banuser.tag : args[0]}`)
