...
module.exports = {
    ...
    try{
      ...
      .setAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/DcR5n6PTFf")]})
      cpuStat.usagePercent(function (e, percent, seconds) {
        ...
        const botinfo = new Discord.MessageEmbed()
            .setAuthor(client.user.tag + " Information", es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL(), `https://discord.com/api/oauth2/authorize?client_id=980288328039538738&permissions=8&scope=bot`) 
            ...
            .addField(client.la[ls].cmds.info.botinfo.field4.title, `\`\`\`yml\nName: RaffiDev#8321\nID: [847710668005572610]\`\`\``, true)
            .addField(client.la[ls].cmds.info.botinfo.field5.title, handlemsg(client.la[ls].cmds.info.botinfo.field5.value, {invitelink: `https://discord.com/api/oauth2/authorize?client_id=980288328039538738&permissions=8&scope=bot`}))
