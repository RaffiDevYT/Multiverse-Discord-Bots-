...
module.exports = {
  ...
  type: "bot",
  description: "Changes if the Advertisement of dash.stromz.ml Should be there or NOT",
        ...
        let menuoptions = [
          {
            ...
            description: `${client.ad.enabled? "Disables the Ads from Stromz" : "Enables the Ads from Stromz"}`,
