  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<:icons_Correct:987931568939102228> Accepted Idea! Expect this soon.`,
          denymsg: `<:icons_Wrong:988298434354249809> Thank you for the feedback, but we are not interested in this idea at this time.`,
