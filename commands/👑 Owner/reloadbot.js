...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let guild = client.guilds.cache.get("966232465901510656")
      return message.reply({content : `**<:icons_Wrong:988298434354249809> THIS COMMAND IS DISABLED, go to discord.gg/stromz and <#990551568271159336> to get it restarted!**\n\n\n> **Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
> **Server:**
...
\`\`\``
      ...
      await tempmsg.edit({embeds: [new MessageEmbed()
        .setColor(es.color).setFooter(client.getFooter(es))
        .setAuthor(`Successfully Reloaded:`, `https://cdn.discordapp.com/emojis/833101995723194437.gif?v=1`, `https://discord.gg/stromz`)
...
/**
 * @INFO
 * Bot Coded by Tomato#6966 | https://discord.gg/stromz
 * @INFO
