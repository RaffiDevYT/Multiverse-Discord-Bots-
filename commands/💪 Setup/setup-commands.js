  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      function getMenuOptions() {
        return [
          ...
          },
          {
            ...
            value: "MINECRAFT",
            emoji: "🤞",
            description: `${client.settings.get(message.guild.id, "MINECRAFT") ? "❌ Disable MINECRAFT Commands" : "✅ Enable MINECRAFT Commands"}`
          },
        ];
      }
      ...
      collector.on("collect", async b => {
        ...
        b?.reply(`<:icons_Correct:987931568939102228> **\`Enabled ${enabled} Command-Categories\` and \`Disabled ${disabled} Command-Categories\` out of \`${b?.values.length} selected Command-Categories\`**`)
      })
...
/**
 * @INFO
 * Bot Coded by RaffiDev#8321 | https://discord.gg/milrato
 * @INFO
 * Work for Stromz Development | https://stormz.ml
 * @INFO
