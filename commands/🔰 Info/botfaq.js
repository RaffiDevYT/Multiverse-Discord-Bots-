...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let milratodc = client.guilds.cache.get("897086237947617281")
      let milratomember = await milratodc.member.fetch().catch(() => {});
      let partnercount = milratomembers.filter(m => m.roles.cache.has("897086237947617281"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/DcR5n6PTFf")
