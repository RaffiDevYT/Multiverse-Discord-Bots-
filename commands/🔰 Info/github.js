...
module.exports = {
	...
	run: async (client, message, args, cmduser, text, prefix) => {
		...
		try {	
			...
			let button_support_dc = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.github?.buttons.dc).setURL("https://discord.gg/DcR5n6PTFf")
			let button_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.github?.buttons.botlist).setURL(`https://bit.ly/Stromz-Website`)
			...
			message.reply({embeds: [new MessageEmbed()
				...
				.setURL("https://bit.ly/Stromz-Website")
