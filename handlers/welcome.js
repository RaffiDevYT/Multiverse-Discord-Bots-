  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<a:Like:988664548577910854> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:joines:988347967364792320> ${invites} Joins | <:leave:988663133000306728> ${leaves} Leaves | <:icons_Wrong:988298434354249809> ${fake} Fakes]`;
      } 
      else if(invite){
