  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try{
      ...
      interaction?.reply({ephemeral: true, embeds: [new Discord.MessageEmbed()
        .setAuthor(handlemsg(client.la[ls].cmds.info.invites.author, {usertag: user.tag}), user.displayAvatarURL({dynamic: true}), "https://discord.gg/DcR5n6PTFf")
...
/*
 * @INFO
 * Bot Coded by Tomato#6966 | https://discord.gg/DcR5n6PTFf
 * @INFO
